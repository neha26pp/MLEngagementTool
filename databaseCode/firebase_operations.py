...
class FirebaseOperations:
    ...
    def initialize_firebase():
        # Replace 'path/to/your/credentials.json' with the path to your Firebase Admin SDK credentials JSON file
        cred = credentials.Certificate('test2-c2612-firebase-adminsdk-oli7i-3d013b8e73.json')
