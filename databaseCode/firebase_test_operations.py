...
class TestFirebaseOperations(unittest.TestCase):
    ...
    def test_upload_file_to_storage_csv(self):
        ...
        storage_path = 'test/rawData/csv/' + file_path
    ...
    def test_upload_file_to_storage_txt(self):
        ...
        storage_path = 'test/rawData/txt/' + file_path
    ...
    def test_add_firestore_document(self):
        ...
        csv_document_path = 'test/rawData/csv/addresses2'
        txt_document_path = 'test/rawData/txt/sample3'
