...
def calculate_engagement_percentage(responses, negative_indices):
    """Calculates the engagement score as a percentage, considering only interest  questions."""
    total_score = 0
    ...
    total_possible_score = len(responses) * 10
...
def read_and_calculate_engagement_percentages(csv_file_path):
    ...
    with open(csv_file_path, newline='', encoding='utf-8') as csvfile:
        ...
        for row in reader:
            ...
            # quiz_responses = row[55:61]  # Adjust for zero-based indexing and includes quiz responses
            ...
            engagement_percentage = calculate_engagement_percentage(responses, negative_indices)
...
print("\nTOPIC 2 TEXT\n")
topic2_text_path = 'C:\\Users\Anthraxlemonaid\\VSCode\\MLEngagementTool\\MyQualtricsDownload\\Post Survey_Engagement Project - Text - Topic 2.csv'
read_and_calculate_engagement_percentages(topic2_text_path)
print("\nTOPIC 2 VIDEO\n")
topic2_video_path = 'C:\\Users\\Anthraxlemonaid\\VSCode\\MLEngagementTool\\MyQualtricsDownload\\Post Survey_Engagement Project - Video - Topic 2.csv'
read_and_calculate_engagement_percentages(topic2_video_path)